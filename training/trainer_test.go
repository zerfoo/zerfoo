...
func (o *mockOptimizer[T]) Step(params []*graph.Parameter[T])                    {}
func (o *mockOptimizer[T]) Clip(params []*graph.Parameter[T], threshold float32) {}

type mockLoss[T tensor.Numeric] struct{}

func (l *mockLoss[T]) Forward(predictions, targets *tensor.Tensor[T]) (T, *tensor.Tensor[T]) {
	var lossValue T
