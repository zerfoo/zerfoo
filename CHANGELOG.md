...
## [1.3.0](https://github.com/zerfoo/zerfoo/compare/v1.2.1...v1.3.0) (2026-03-16)


### Features

* **examples:** add api-server and embedding examples ([4a4c28a](https://github.com/zerfoo/zerfoo/commit/4a4c28a91fd1375866cf6df7599ea93a2c14b65e))

## [1.2.1](https://github.com/zerfoo/zerfoo/compare/v1.2.0...v1.2.1) (2026-03-16)


### Bug Fixes

* **cli:** replace zmf references with gguf in predict command ([b410a33](https://github.com/zerfoo/zerfoo/commit/b410a33276839c10d50ec24f2e504bd6e2017276))

## [1.2.0](https://github.com/zerfoo/zerfoo/compare/v1.1.0...v1.2.0) (2026-03-15)


### Features

* **compute:** add debug logging for large GPU allocations ([1433ea1](https://github.com/zerfoo/zerfoo/commit/1433ea1f873ab60cf5b78ceaf0951466a280b4ec))
* **compute:** add GPU Sin kernel with CPU parity tests ([fab7800](https://github.com/zerfoo/zerfoo/commit/fab7800c63f1caab2e7ad9c6d45305741d7b1cc3))
* **cuda:** add kernel_sin and launch_sin to elementwise.cu ([a28a7bc](https://github.com/zerfoo/zerfoo/commit/a28a7bc095dc082a10c95af64ed6fdbac1916501))
* **generate:** add --repetition-penalty flag to bench_tps ([95bd02f](https://github.com/zerfoo/zerfoo/commit/95bd02f49bff9801988ef392e0acad3a8d62b881))
* **generate:** wire --repetition-penalty CLI flag through run command ([2be74da](https://github.com/zerfoo/zerfoo/commit/2be74dad53ae0e99dd75828740ed28a924ac117a))
* **gpuapi:** add Sin and Cos to KernelRunner interface ([148e696](https://github.com/zerfoo/zerfoo/commit/148e696470789692b966685d835c0b4e563dcb69))
* **gpuapi:** add Sin to KernelRunner interface and implementations ([7ffafe2](https://github.com/zerfoo/zerfoo/commit/7ffafe2fcb32cea71836d902b26994b339752b01))
* **graph:** add PreUploadFrozenWeights for CUDA graph capture ([69c48af](https://github.com/zerfoo/zerfoo/commit/69c48af3fc904de4740a388e6b009b65990715a9))
* **graph:** add RMSNorm fusion pass for ONNX models ([73389aa](https://github.com/zerfoo/zerfoo/commit/73389aa8d73d7ac54d95c729dd55e935361c9052))
* **graph:** complete RMSNorm fusion with GPU dispatch and clean API ([94bade2](https://github.com/zerfoo/zerfoo/commit/94bade2184fa24264c51e63823d881f68fb1dc6a))
* **graph:** make static Reshape capturable for CUDA graph ([655069a](https://github.com/zerfoo/zerfoo/commit/655069a292bcbc27028ec33853c743e3d79183e0))
* **graph:** wire RMSNorm fusion into CompileTraced pipeline ([c56cc01](https://github.com/zerfoo/zerfoo/commit/c56cc0119bd3733f8ab48aa6a5e26c8b466377a7))
* **layers/core:** add GPU path for Expand op using broadcast multiply ([d03e704](https://github.com/zerfoo/zerfoo/commit/d03e704e615bef1edf6eba1a60e31aaa1cba5726))
* **layers/core:** add GPU ScatterND path ([a875601](https://github.com/zerfoo/zerfoo/commit/a875601bde8378b6aacbccb05971d372b3c940fb))
* **layers/core:** wire Sin op to engine.Sin for GPU dispatch ([150ce48](https://github.com/zerfoo/zerfoo/commit/150ce489ddf5268d43cd867674f7f141725725ef))
* **serve:** add panic recovery middleware and OOM error handling ([b0b8029](https://github.com/zerfoo/zerfoo/commit/b0b8029e073357b0ed1629d61e6b1c5adcc812ec))
* **serve:** add structured request logging ([e0a4637](https://github.com/zerfoo/zerfoo/commit/e0a4637a193074bc9a20fcebf2572cb5d20fdcfd))
* **serve:** add token rate metrics and /metrics endpoint ([b5dcb72](https://github.com/zerfoo/zerfoo/commit/b5dcb729ddbbdc208ef217818b37334e91d5a26e))


### Bug Fixes

* **ci:** remove || true from lint step to enforce strict linting ([88b17c3](https://github.com/zerfoo/zerfoo/commit/88b17c329be1caedcd1335a6fcc3fd674f1d8c15))
* **compute:** detect flattenTo2D shape collapse in gpuBroadcastOp ([61e43ee](https://github.com/zerfoo/zerfoo/commit/61e43ee6cfe852aeaa58e415d8b3036aff4c74a2))
* **compute:** eliminate CPU fallback in GPU broadcast during capture ([498a8f7](https://github.com/zerfoo/zerfoo/commit/498a8f7ae8a93012b543a66f5fd4eb19db9d8ddc))
* **compute:** handle 2D tensors in EngineProxy MatMulTransposeB fallback ([df6b47d](https://github.com/zerfoo/zerfoo/commit/df6b47d309aca5e6c9b10df5bb6c130be87c10c3))
* **compute:** remove isGPU early exit from Transpose for graph capture compatibility ([e5d4f38](https://github.com/zerfoo/zerfoo/commit/e5d4f38bf43feb65f2f1b903619725d5ed0a938a))
* **compute:** remove unused gpuSubScalar and fix ineffassign for c4 in gpu_cudnn.go ([79e9ccb](https://github.com/zerfoo/zerfoo/commit/79e9ccb23956fc663236fde2cca55ae26447e36c))
* **compute:** use relative tolerance in TestCPUEngine_Exp ([b124fbe](https://github.com/zerfoo/zerfoo/commit/b124fbe1782e7925b688849a37072cecb448329e))
* **core:** add bounds checking to Range op to prevent index OOB panic ([8f3efc6](https://github.com/zerfoo/zerfoo/commit/8f3efc6c3d5f7154b93221a645432ddf474cd8bc))
* **core:** add N-D broadcasting to Or op ([3cb1234](https://github.com/zerfoo/zerfoo/commit/3cb1234dfb0b2c1ed02af08f02313a2d05e80f8f))
* **core:** add N-D broadcasting to Or op ([7118c33](https://github.com/zerfoo/zerfoo/commit/7118c33e27b6a241d92c417ab493b0f9fbdfb1d4))
* **cublas:** handle errcheck in test cleanup ([20d7181](https://github.com/zerfoo/zerfoo/commit/20d71811c9523ede841381bfed8b8baf1f4ff91c))
* **cuda/kernels:** handle errcheck in flash attention tests ([4269e32](https://github.com/zerfoo/zerfoo/commit/4269e3238e8e6061ad214061b76a2432222655d8))
* **cuda:** handle negative bases in powf scalar kernel ([03682d2](https://github.com/zerfoo/zerfoo/commit/03682d23da99cae038e7c73b5cb525f8cb8bc847))
* **cudnn:** handle errcheck in test cleanup ([ae1a06e](https://github.com/zerfoo/zerfoo/commit/ae1a06e7d427a5696ab8b7c2cc44b931232b795c))
* **generate:** reset stateful graph nodes before each generation ([48059df](https://github.com/zerfoo/zerfoo/commit/48059df176009b9aefa8bcf3598680bdb2f608ee))
* **generate:** restore cache state on CUDA graph capture failure ([20c9423](https://github.com/zerfoo/zerfoo/commit/20c9423c3fd98e5f9108d683166dcd691e4f1037))
* **gpuapi:** handle errcheck in defer Destroy calls ([a9360d8](https://github.com/zerfoo/zerfoo/commit/a9360d8329499da70791b74441632bdc8220aa9d))
* **graph:** accept different x-slots in RMSNorm fusion for ONNX Cast ops ([ec4d028](https://github.com/zerfoo/zerfoo/commit/ec4d028098d21e4bb696bb1292a85d39459bb3f8))
* **graph:** add AutoAttentionMask and AutoPositionIds to nonCapturableOps ([b8007d1](https://github.com/zerfoo/zerfoo/commit/b8007d1b9f220691e8dc2dcc283d6b37092ed5f1))
* **graph:** add ConstantOfShape and Shape to nonCapturableOps ([75600b0](https://github.com/zerfoo/zerfoo/commit/75600b09d04ca3e13a2055de42bd69174bffafa8))
* **graph:** add Gather to nonCapturableOps for CUDA graph capture ([df3c7c0](https://github.com/zerfoo/zerfoo/commit/df3c7c06d9f9e87e9d35d916c2320a89582c1e76))
* **graph:** add Resettable interface and ResetStatefulNodes method ([7a0ecc3](https://github.com/zerfoo/zerfoo/commit/7a0ecc3a2d4bf3e6f27c0a929d3f3d280c96fca4))
* **graph:** add Reshape to nonCapturableOps ([8b37174](https://github.com/zerfoo/zerfoo/commit/8b37174cb072f5be2a7bc5fd3fee33169f6d477d))
* **graph:** add Slice to nonCapturableOps ([bbf522e](https://github.com/zerfoo/zerfoo/commit/bbf522e3ca303bd73b2c61a9a526f42213ff207b))
* **graph:** add StatefulInputNode interface for KV cache state feedback ([e0fac81](https://github.com/zerfoo/zerfoo/commit/e0fac81dee8adce10bf967867b4e78758ab96211))
* **graph:** find longest contiguous capturable region + add Slice/Reshape ([759d1ea](https://github.com/zerfoo/zerfoo/commit/759d1ea3906b21abe290c69e9767c0947fdf5a41))
* **graph:** keep scalar constants CPU-resident in PreUploadFrozenWeights ([ce1e155](https://github.com/zerfoo/zerfoo/commit/ce1e1551b13efaeb6244420bce663198f394741e))
* **graph:** longest contiguous capturable region + nonCapturableOps expansion ([1391219](https://github.com/zerfoo/zerfoo/commit/13912191951e4b1a1903cc65f3d2d36d9fce7845))
* **graph:** relax RMSNorm fusion to match Compile path instructions ([3f630fd](https://github.com/zerfoo/zerfoo/commit/3f630fd10d3558bf51f03fc3be0212290a527653))
* **graph:** scan all instructions for non-capturable ops in capture region ([c1704c7](https://github.com/zerfoo/zerfoo/commit/c1704c703a09f911c0b6d53ee13b871716909d61))
* **graph:** snapshot/restore KV cache on CUDA graph capture failure ([425e0c6](https://github.com/zerfoo/zerfoo/commit/425e0c62d0c90f4aea7c48fc867016233df38868))
* **graph:** upload all CPU slots in EnsureSlotsGPU including frozen scalars ([732d8a1](https://github.com/zerfoo/zerfoo/commit/732d8a1aa2f0b853e27261cd6cedf45346e8da85))
* **graph:** upload frozen scalar inputs for capture-region instructions ([aa9a207](https://github.com/zerfoo/zerfoo/commit/aa9a2074cfdef89e80621ad611f7d75fb82f94ce))
* **graph:** use connectivity-based pattern matching for RMSNorm fusion ([7d9c41d](https://github.com/zerfoo/zerfoo/commit/7d9c41df93a949946f54524e7fa504d27b511926))
* **graph:** use outToInstr-based static slot detection for RMSNorm fusion ([0528543](https://github.com/zerfoo/zerfoo/commit/05285435f4b43e99bc59092b79b12d0ac4a9a994))
* **graph:** use Pow's x-slot for fused RMSNorm (avoids Cast dependency) ([e3fa60d](https://github.com/zerfoo/zerfoo/commit/e3fa60d7dd668c2981e38e4794e1bfd00e59df91))
* **graph:** wire RMSNorm fusion into Compile path for ONNX models ([e706a85](https://github.com/zerfoo/zerfoo/commit/e706a85472f6f4baf9d156de802e04d6375f16cf))
* **hip:** handle errcheck in test cleanup ([4ae6f97](https://github.com/zerfoo/zerfoo/commit/4ae6f976a2f6302fbf73d56aeebf3ef50c7efe99))
* **inference:** use MatMulTransposeB for lmHeadNode to fix cuBLAS status 7 ([2bb4689](https://github.com/zerfoo/zerfoo/commit/2bb468945295b0fc4bfcb9b5d8676fa375437189))
* **layers/core:** handle tensor-typed fill value in ConstantOfShape ([216fdf5](https://github.com/zerfoo/zerfoo/commit/216fdf53148825360108a17fe47f317dac9e474d))
* **layers/core:** prevent Cast from aliasing input tensor in graph memo ([2958d67](https://github.com/zerfoo/zerfoo/commit/2958d670fc6458216740bdff068fb01e657a9257))
* **layers/gather:** clamp OOB indices in embedding-path Gather ([f0e4897](https://github.com/zerfoo/zerfoo/commit/f0e48970fadcc5cfa71625c182156580171a0d0f))
* **layers:** add N-D broadcasting to Greater and Where ops ([10219e2](https://github.com/zerfoo/zerfoo/commit/10219e2e0eec366fc653c5b28d5948f5227e0624))
* **layers:** remove stale GPU tensor caching in Transpose and MatMul ([b0417c9](https://github.com/zerfoo/zerfoo/commit/b0417c907e98610fd933ca2fe965392bedd1c763))
* **layers:** use MatMulTransposeB for tied LM head to fix cuBLAS status 7 ([ebd2331](https://github.com/zerfoo/zerfoo/commit/ebd2331e0033a26098bf30bd90e54e45669d92d9))
* **lint:** rename duplicate constantNode in optimize_test.go ([590845a](https://github.com/zerfoo/zerfoo/commit/590845ab634a01a6d4614b9f8d76008d90bd382c))
* **lint:** resolve errcheck and dupl findings in serve/ ([263737c](https://github.com/zerfoo/zerfoo/commit/263737c81e6034fcbefe55c25ce25de9f4d99166))
* **model:** implement Reset() on stateful auto-input nodes ([5370ba0](https://github.com/zerfoo/zerfoo/commit/5370ba0cc1ff436f7c06a092150a6edfd64a1ff7))
* **model:** wire KV cache feedback, fix position IDs and attention mask ([189926e](https://github.com/zerfoo/zerfoo/commit/189926eac6da4daabfc404508e5ae6e6d9fb21e3))
* **tensorrt:** handle errcheck in test cleanup ([951b763](https://github.com/zerfoo/zerfoo/commit/951b7633b4af1278573c161cbcf765681f92b819))
* **tokenizer:** detect SentencePiece mode in LoadFromJSON ([dbe09d8](https://github.com/zerfoo/zerfoo/commit/dbe09d83c0821b01a8f17fe5fe56076761505cfe))
* use x*x for the common s==2 case, fabsf(x) for general case. ([03682d2](https://github.com/zerfoo/zerfoo/commit/03682d23da99cae038e7c73b5cb525f8cb8bc847))
