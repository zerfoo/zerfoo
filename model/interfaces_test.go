...
func TestModelRegistry_AllComponentTypes(t *testing.T) {
	...
	_ = registry.RegisterModelProvider("test_provider", providerFactory)
	_ = registry.RegisterModelSerializer("test_serializer", serializerFactory)
	_ = registry.RegisterModelLoader("test_loader", loaderFactory)
...
func TestModelRegistry_ThreadSafety(t *testing.T) {
	...
	go func() {
		...
		for i := 0; i < 50; i++ {
			...
			_ = registry.RegisterModelProvider("provider_"+string(rune('a'+i%26)), factory)
		}
	}()
...
func TestRegistryClear(t *testing.T) {
	...
	_ = registry.RegisterModelProvider("test", factory)
