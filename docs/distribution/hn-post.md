...
Show HN: Zerfoo -- Run LLMs in Pure Go, 18.8% Faster Than Ollama
...
On Gemma 3 1B Q4_K_M, Zerfoo decodes at 234.30 tok/s on a DGX Spark --
18.8% faster than Ollama on the same hardware with the same model file.
