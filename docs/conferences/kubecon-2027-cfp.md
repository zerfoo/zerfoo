...
Q4_K_M — 18% faster than Ollama on identical hardware. GPU acceleration (CUDA,
...
- **Quantized inference**: Q4_K_M, Q8_0, and other GGUF quantization formats
  run natively. The 234 tok/s benchmark on Gemma 3 1B Q4_K_M uses quantized
...
| 14:00 | Performance | 234 tok/s benchmark, CUDA graph capture (99.5% coverage), quantized GEMM, ARM NEON |
...
4. **234 tok/s in pure Go is competitive with C++ runtimes.** Fused operations,
