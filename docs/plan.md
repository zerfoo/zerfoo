...
- [x] T128.5 Verification sweep and devlog record  2026 07 02  (DONE: sweep found 15 more closable + #521 to park, executed by coordinator; final state 60 open = 27 live + 33 parked; no over-closure; devlog entry redone by coordinator after agent's commit was lost)  Owner: TBD  Est: 45m  delivers: [devlog entry: final tracker state]  kind: agent  blocked-by: [T128.1, T128.2, T128.3, T128.4]
...
- [x] T129.2 Loud-failure gate on capture-replay training  2026 07 02  (DONE PR #920: ErrCaptureTrainingDisabled at NewCaptureReplayRunner; constructor now returns error; design.md 21.5)  Owner: TBD  Est: 1.5h  verifies: [UC-H2-001]  kind: agent  blocked-by: [T129.1]
