...
- [ ] T130.2 Create docs/lore.md  Owner: TBD  Est: 1.5h  delivers: [greppable landmine/invariant register]  kind: agent
...
- [ ] T130.3 Regenerate docs/adr/README.md  Owner: TBD  Est: 1h  delivers: [complete ADR index 001-093 with status]  kind: agent
...
- [ ] T130.6 design.md consistency pass  Owner: TBD  Est: 1.5h  delivers: [design.md matches current doctrine]  kind: agent
