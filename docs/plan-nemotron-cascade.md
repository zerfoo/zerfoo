...
- [x] T1.1 Add SSM config fields to ModelConfig  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
...
- [x] T1.2 Add Nemotron-H tensor name mapping  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
  File: model/gguf/arch.go
...
- [x] T2.1 Implement Nemotron-H dense graph builder  Owner: TBD  Est: 3h  verifies: [UC-001]
...
- [x] T2.2 Implement Nemotron-H-MoE graph builder  Owner: TBD  Est: 2h  verifies: [UC-001]
  Deps: T2.1
...
- [x] T2.3 Register nemotron_h and nemotron_h_moe  Owner: TBD  Est: 0.5h  verifies: [UC-001]
...
- [x] T3.1 Verify MIMOMambaBlock compatibility with Nemotron-H  Owner: TBD  Est: 1h  verifies: [UC-001]
...
- [x] T4.1 Unit tests for Nemotron-H builder  Owner: TBD  Est: 1.5h  verifies: [UC-001]
...
- [x] T4.2 Unit tests for Nemotron-H-MoE builder  Owner: TBD  Est: 1h  verifies: [UC-001]
  Deps: T4.1
...
- [x] T4.3 Tensor name mapping tests  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
...
- [x] T4.4 Run go vet and linters  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
  Deps: T2.3
...
- [x] T5.1 Update README with Nemotron-H architecture  Owner: TBD  Est: 0.5h  delivers: [README update]
...
- [x] T1.1 Add SSM config fields
- [x] T1.2 Add Nemotron-H tensor name mapping
- [x] T3.1 Verify MIMOMambaBlock compatibility

#### Wave 2: Implementation (3 agents)
- [x] T2.1 Implement Nemotron-H dense builder  Deps: T1.1, T1.2, T3.1
- [x] T2.2 Implement Nemotron-H-MoE builder  Deps: T2.1
- [x] T2.3 Register architectures  Deps: T2.1

#### Wave 3: Verification (5 agents)
- [x] T4.1 Unit tests dense  Deps: T2.3
- [x] T4.2 Unit tests MoE  Deps: T2.3
- [x] T4.3 Tensor name mapping tests  Deps: T1.2
- [x] T4.4 Run go vet  Deps: T2.3
- [x] T5.1 Update README  Deps: T2.3
