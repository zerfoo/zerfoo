...
- [x] T1.1 Add olmo2 architecture builder  Owner: TBD  Est: 1.5h  verifies: [UC-001]
...
- [x] T1.2 Add internlm2 architecture builder  Owner: TBD  Est: 1.5h  verifies: [UC-001]
...
- [x] T1.3 Add exaone architecture builder  Owner: TBD  Est: 1.5h  verifies: [UC-001]
...
- [x] T1.4 Add starcoder2 architecture builder  Owner: TBD  Est: 1.5h  verifies: [UC-001]
...
- [x] T1.5 Add dbrx architecture builder  Owner: TBD  Est: 2h  verifies: [UC-001]
...
- [x] T1.6 Tests for llama-like architectures  Owner: TBD  Est: 2h  verifies: [UC-001]
  Deps: T1.1-T1.5
  Synthetic weight tests for each builder.

- [x] T1.7 Register all E1 architectures  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
  Deps: T1.1-T1.5
...
- [x] T2.1 Add GLM4 architecture builder  Owner: TBD  Est: 3h  verifies: [UC-001]
...
- [x] T2.2 Add GLM4-MoE variant  Owner: TBD  Est: 1.5h  verifies: [UC-001]
  Deps: T2.1
...
- [x] T2.3 Add GLM-DSA (deepseek2-ocr) support  Owner: TBD  Est: 1h  verifies: [UC-001]
  Extend existing DeepSeek2 builder or create thin wrapper.
  Register: "deepseek2-ocr", "glm-dsa"
  Acceptance: glm-ocr GGUF loads.

- [x] T2.4 GLM tensor name mapping  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
  File: model/gguf/arch.go

- [x] T2.5 Tests for GLM builders  Owner: TBD  Est: 1.5h  verifies: [UC-001]
  Deps: T2.1-T2.3
...
- [x] T3.1 Research Kimi linear attention mechanism  Owner: TBD  Est: 1h  verifies: [infrastructure]
...
- [x] T3.2 Implement Kimi linear attention layer  Owner: TBD  Est: 3h  verifies: [UC-001]
  Deps: T3.1
...
- [x] T3.3 Implement buildKimiGraph  Owner: TBD  Est: 3h  verifies: [UC-001]
  Deps: T3.2
...
- [x] T3.4 Kimi tensor name mapping  Owner: TBD  Est: 0.5h  verifies: [infrastructure]

- [x] T3.5 Tests for Kimi builder  Owner: TBD  Est: 1.5h  verifies: [UC-001]
  Deps: T3.3
...
- [x] T4.1 Research LFM2 architecture  Owner: TBD  Est: 1h  verifies: [infrastructure]
  Read llama.cpp implementation. Determine layer types and dispatch pattern.
  LFM2 may use custom SSM or attention variants.

- [x] T4.2 Implement buildLFM2Graph  Owner: TBD  Est: 3h  verifies: [UC-001]
  Deps: T4.1
  File: inference/arch_lfm2.go (new)
  Register: "lfm2", "lfm2moe"
  Acceptance: lfm2 GGUF loads.

- [x] T4.3 Tests for LFM2 builder  Owner: TBD  Est: 1.5h  verifies: [UC-001]
  Deps: T4.2

### E5: Verification and Documentation

- [x] T5.1 Run go vet and linters for all new architectures  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
  Deps: all above

- [x] T5.2 Update README with new architectures  Owner: TBD  Est: 0.5h  delivers: [README update]
  Update architecture count and model grid.

- [x] T5.3 Update website model grid  Owner: TBD  Est: 0.5h  delivers: [website update]
...
- [x] T2.1 GLM4 builder
- [x] T2.4 GLM tensor mapping
- [x] T3.1 Research Kimi linear attention
- [x] T4.1 Research LFM2 architecture
- [x] T1.6 Tests for Wave 1  Deps: T1.1-T1.5

#### Wave 3: Complex Architectures (5 agents)
- [x] T2.2 GLM4-MoE  Deps: T2.1
- [x] T2.3 GLM-DSA  Deps: T2.1
- [x] T3.2 Kimi linear attention layer  Deps: T3.1
- [x] T4.2 LFM2 builder  Deps: T4.1
- [x] T1.7 Register all E1 architectures  Deps: T1.1-T1.5

#### Wave 4: Kimi Builder + Tests (5 agents)
- [x] T3.3 buildKimiGraph  Deps: T3.2
- [x] T3.4 Kimi tensor mapping
- [x] T2.5 GLM tests  Deps: T2.1-T2.3
- [x] T4.3 LFM2 tests  Deps: T4.2
- [x] T3.5 Kimi tests  Deps: T3.3

#### Wave 5: Verification (3 agents)
- [x] T5.1 go vet  Deps: all above
- [x] T5.2 Update README
- [x] T5.3 Update website
