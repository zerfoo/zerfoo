...
- [ ] T1.1 Add MoESigmoidGate to layers/core/moe.go  Owner: TBD  Est: 1.5h  verifies: [infrastructure]
...
- [ ] T1.2 Unit tests for sigmoid gate  Owner: TBD  Est: 1h  verifies: [infrastructure]
...
- [ ] T2.1 Add MiniMax-M2 tensor name mapping  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
...
- [ ] T2.2 Add ScoringFunc to ModelConfig  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
...
- [ ] T3.1 Implement buildMiniMaxM2Graph  Owner: TBD  Est: 4h  verifies: [UC-001]
  Deps: T1.1, T2.1, T2.2
...
- [ ] T3.2 Register minimax-m2 architecture  Owner: TBD  Est: 0.25h  verifies: [UC-001]
  Deps: T3.1

### E4: Tests

- [ ] T4.1 Unit tests for builder  Owner: TBD  Est: 2h  verifies: [UC-001]
  Deps: T3.2. Synthetic tensors (4 layers, 4 experts, top-2).

- [ ] T4.2 Tensor name mapping tests  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
  Deps: T2.1

- [ ] T4.3 Run go vet and linters  Owner: TBD  Est: 0.5h  verifies: [infrastructure]
  Deps: T3.2

### E5: Documentation

- [ ] T5.1 Update README  Owner: TBD  Est: 0.5h  delivers: [README update]
...
- [ ] T1.1 Sigmoid MoE gate
- [ ] T2.1 Tensor name mapping
- [ ] T2.2 ScoringFunc config field

#### Wave 2: Implementation (2 agents)
- [ ] T3.1 buildMiniMaxM2Graph  Deps: T1.1, T2.1, T2.2
- [ ] T3.2 Register architecture  Deps: T3.1

#### Wave 3: Verification (5 agents)
- [ ] T1.2 Sigmoid gate tests  Deps: T1.1
- [ ] T4.1 Builder tests  Deps: T3.2
- [ ] T4.2 Tensor mapping tests  Deps: T2.1
- [ ] T4.3 go vet  Deps: T3.2
- [ ] T5.1 README  Deps: T3.2
