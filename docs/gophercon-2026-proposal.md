...
others), and delivers 245 tokens/second on Gemma 3 1B — 20% faster than Ollama
...
- Benchmark results: 245 tok/s on Gemma 3 1B Q4_K_M vs Ollama 204 tok/s (+20%)
...
**Title:** "245 tok/s in Pure Go: ML Inference Without CGo"
...
3. **(1.5 min)** Live demo: 7 lines of Go to load Gemma 3 and generate text,
   show tok/s output
4. **(1 min)** Results: 245 tok/s, 20% faster than Ollama, 15+ model
